...
from modules import dashboard, cnps, seguro, relatorios  # Importando os módulos
import logging
...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([
            # Logo do BRB
            html.Img(src="/assets/imagens/Bodyx.jpeg", style={"width": "100%", "padding": "10px"}),
            dbc.Nav([
...
if __name__ == "__main__":
    app.run(debug=False, host='0.0.0.0', port=8050)  # Alterado de run_server para run